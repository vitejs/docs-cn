...
- **类型：** `string | boolean`
- **默认：** [`server.host`](./server-options#server_host)
...
- **类型：** `boolean`
- **默认：** [`server.strictPort`](./server-options#server_strictport)
...
- **默认：** [`server.https`](./server-options#server_https)
...
- **类型：** `boolean | string`
- **默认：** [`server.open`](./server-options#server_open)
...
- **默认：** [`server.cors`](./server-options#server_proxy)
