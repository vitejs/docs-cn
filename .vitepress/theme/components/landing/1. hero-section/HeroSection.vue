  ...
  <div class="hero">
    <div class="container">
      ...
      <a
        ...
        target="_blank"
      >
        <img src="/viteconf.svg" alt="ViteConf 标志" width="20" height="20" />
        <span>ViteConf 2024 演讲</span>
      </a>

      <!-- Heading -->
      <h1>为 Web 而生的<br />构建工具</h1>
      <!-- Tagline -->
      <h3>
      ...
      <div class="hero__actions">
        ...
        >
          <img src="/github.svg" alt="GitHub 标志" width="20" height="20" />
          GitHub
        </a>
      </div>
    </div>
