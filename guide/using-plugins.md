...
若要使用插件，需要将它添加到项目的 `devDependencies`，并在 `vite.config.js` 配置文件的 `plugins` 数组中引入。例如，要为传统浏览器提供支持，可以像下面这样使用官方插件 [@vitejs/plugin-legacy](https://github.com/vitejs/vite/tree/v4/packages/plugin-legacy)：
