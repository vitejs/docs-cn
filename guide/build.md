...
传统浏览器可以通过插件 [@vitejs/plugin-legacy](https://github.com/vitejs/vite/tree/v4/packages/plugin-legacy) 来支持，它将自动生成传统版本的 chunk 及对应 ES 语言特性的 polyfill。兼容版 chunk 只会在不支持原生 ESM 的浏览器中按需加载。
