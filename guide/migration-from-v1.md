...
Vite 2.0 核心已经与框架无关。Vue 支持由 [`@vitejs/plugin-vue`](https://github.com/vitejs/vite/tree/v2/packages/plugin-vue)提供。安装它并添加到 Vite 配置十分简单：
...
现已支持 React Fast Refresh，详见 [`@vitejs/plugin-react`](https://github.com/vitejs/vite/tree/v2/packages/plugin-react)。
