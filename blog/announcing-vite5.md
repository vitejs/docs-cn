...
- [变更日志](https://github.com/vitejs/vite/blob/v5/packages/vite/CHANGELOG.md#500-2023-11-16)
...
你可以在 [Vite 5 变更日志](https://github.com/vitejs/vite/blob/v5/packages/vite/CHANGELOG.md#500-2023-11-16) 中找到对 Vite 核心的全面变更列表。
